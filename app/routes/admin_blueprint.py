...
from app.controllers.admin_controller import create_admin, create_prize, login_admin, update_avatar, update_event
...
bp_admin.patch("/update/<int:id>")(update_event)
